...
import DetalleNivelKit from './DetalleNivelKit/DetalleNivelKit.jsx';
import DetalleNivelNivelesKit from './DetalleNivelKit/DetalleNivelNivelesKit/DetalleNivelNivelesKit.jsx';
import DetalleNivelVideoKit from './DetalleNivel/DetallaNivelVideoKit/DetalleNivelVideoKit.jsx';
...
>
      ...
      <Stack.Screen name="DetalleNivelKit" component={DetalleNivelKit} options={{ title: 'Detalle nivel video' }} />
      <Stack.Screen name="DetalleNivelNivelesKit" component={DetalleNivelNivelesKit} options={{ title: 'Detalle nivel video' }} />
      <Stack.Screen name="DetalleNivelVideoKit" component={DetalleNivelVideoKit} options={{ title: 'Detalle nivel video' }} />
